...
export default function Kids() {
  return (
    <div className='container-fluid temp_anim9'>
      <div className='container'>
        <div className='row'>
          <div className='col-4 d-flex flex-column' data-aos="fade-up" data-aos-duration="1500"  data-aos-offset="10%" data-aos-trigger="scroll" data-aos-anchor=".temp_anim9" data-aos-anchor-placement="top-bottom" data-aos-easing="linear">
          ...
          <div className='col-4 d-flex flex-column' data-aos="fade-up" data-aos-duration="1600"  data-aos-offset="10%" data-aos-trigger="scroll" data-aos-anchor=".temp_anim9" data-aos-anchor-placement="top-bottom" data-aos-easing="linear">
            <div className='col-12 mb-4 overflow-hidden'>
          ...
          <div className='col-4 d-flex flex-column' data-aos="fade-up" data-aos-duration="1700"  data-aos-offset="10%" data-aos-trigger="scroll" data-aos-anchor=".temp_anim9" data-aos-anchor-placement="top-bottom" data-aos-easing="linear">
            <div className='col-12 mb-4 overflow-hidden'>
