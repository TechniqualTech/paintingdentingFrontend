...
export default function Contact() {
    return (
        <div className='container temp_anim16'>
            ...
            <div className='d-flex flex-column'>
                <div className='row my-2' {...getFadeUpAnimationAttributes({  duration: 1500, anchor: '.temp_anim16' })}>
                    <div className='col-6 shadow p-4 scaling_p'>
                        ...
                        <p>Navi Mumabi, Ghansoli Near Dmart House no 810 ,room 406 -400701</p>
                    </div>
                    <div className='col-6 shadow p-4 scaling_p'>
